...
// Dummy blog data (replace with your actual blog posts)
const blogs = [
	{
		title: "Coming Soon",
		description:
			"Stay tuned for professional articles, tutorials, and insights on web development, design, and technology trends.",
		date: "2025-06-21",
		tags: ["Web Development", "Design", "Trends"],
	},
			...
			<div className="w-full max-w-5xl mx-auto px-0 md:px-8 relative z-10">
				...
				>
					{blogs.map((blog, idx) => (
						...
						>
							{/* Timeline Dot (optional, for visual consistency) */}
							...
							{/* Blog Content - full width, no card */}
							<div className="ml-14 flex-1 flex flex-col gap-3 bg-transparent rounded-none shadow-none px-0 py-0 transition-transform duration-300 group-hover:scale-[1.01] group-focus:scale-[1.01]">
								<div className="flex flex-col md:flex-row md:items-center md:gap-6 flex-wrap">
									...
									<span className="text-base md:text-lg text-[#201d66] font-medium md:ml-4">
										{blog.date}
									</span>
								</div>
								{/* Tags */}
