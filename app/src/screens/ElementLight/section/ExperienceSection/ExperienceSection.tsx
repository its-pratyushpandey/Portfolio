...
"Developed a portfolio showcasing web development and programming expertise.",
	...
	},
	{
		...
		details: [
	"Built foundational skills in C, HTML, CSS.",
			"Created basic websites, sparking interest in web development.",
      "Explored various programming languages and frameworks.",
      "Contributed to school projects involving basic web applications.",
      "Developed a passion for software development and web technologies.",
		...
		>
			...
			<main className="relative z-10 flex-1 flex flex-col items-center justify-center px-2 md:px-12 py-12 md:py-24 min-h-[60vh]">
				...
				>
					...
					{selectedExp.company === "Smart India Hackathon" && (
  <div className="flex flex-wrap gap-4 mt-2">
    <a
      href="https://github.com/its-pratyushpandey/PrivatePortfolio.git"
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-4 py-2 bg-[#201d66] text-white rounded-lg font-semibold shadow hover:bg-[#3949ab] transition text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-[#3949ab]"
    >
    ...
    <a
      href="https://prtyush.netlify.app/"
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-4 py-2 bg-[#80deea] text-[#201d66] rounded-lg font-semibold shadow hover:bg-[#b3e5fc] transition text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-[#3949ab]"
    >
      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14 3h7v7m0 0L10 21l-7-7L21 10z"/></svg>
      Visit Site
    </a>
  </div>
)}
{selectedExp.company === "PFSD Hackathon" && (
  <div className="flex flex-wrap gap-4 mt-2">
    <a
      href="https://github.com/its-pratyushpandey/Code-Sync.git"
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-4 py-2 bg-[#201d66] text-white rounded-lg font-semibold shadow hover:bg-[#3949ab] transition text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-[#3949ab]"
    >
