...
const contactInfo: ContactItem[] = [
  ...
  { icon: 'https://c.animaapp.com/mc46fmevF9sLme/img/component-2-45.svg', text: 'Bento', link: 'https://bento.me/pratyush' },
  ...
  { icon: 'https://c.animaapp.com/mc46fmevF9sLme/img/component-2-9.svg', text: 'X [Twitter]', link: 'https://x.com/pratyush_pandey' },
